...
const PortfolioGrid = ({ categories, isLoading = false }: PortfolioGridProps) => {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">There are no portfolio categories to display at the moment.</p>
        </div>
      </div>
    )
  }
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((category) => {
          ...
          return (
            ...
            >
              <Card className="overflow-hidden relative hover:shadow-lg transition-all duration-300 transform p-0 hover:scale-105 border-0 aspect-video">
